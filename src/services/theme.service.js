const themes = [
    ...
    { CourseId: 1, ThemeId: 8, ThemeTitle: 'Porcentaje', redirectTo: 'percentage' },
    { CourseId: 1, ThemeId: 9, ThemeTitle: 'MCM', redirectTo: 'division' },
    { CourseId: 1, ThemeId: 10, ThemeTitle: 'MCD', redirectTo: 'division' },
    { CourseId: 1, ThemeId: 11, ThemeTitle: 'Operaciones Combinadas', redirectTo: 'mixedOperations' },
    { CourseId: 1, ThemeId: 12, ThemeTitle: 'Sistemas Númericos', redirectTo: 'numericSystem' },
];
